    ...
    <form onSubmit={handleSubmit}>
      <Flex flexDir='column' justify='space-evenly' bgColor='white' borderRadius='10' w='sm' minH='md' p='5' textAlign='left'>
        ...
        <FormControl isInvalid={emailvalidation} my='2' isRequired>
          ...
          <Input
            autoFocus type='email' value={email} placeholder='Enter your email address'
            onChange={e =>
        ...
        <FormControl isInvalid={passwordValidation} isRequired my='2'>
          ...
          <Input
            type='password' value={password} placeholder='Enter your password' maxLength={64}
        ...
        <HStack justifyContent='space-between' my='4'>
          <Checkbox
            colorScheme='linkedin' isChecked={remember} onChange={(e) => {
